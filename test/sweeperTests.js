...
testFieldToGrid: function(attribute){
	var field = "..*\n"+
				"*..\n"+
				"...";
...
testCountMinedNeighbours: function(){
	var grid = new Grid([[".",".","*"],
						["*",".","."],
						[".",".","."]]);
	var expectedMineCountin11Pos = 2;
	var actualCount = sweeper.countMinedNeighbours(grid, 1, 1);					
	assertEquals(expectedMineCountin11Pos, actualCount);
},
...
testGameInit: function(){
	...
	var noOfButtonsCreated = $(".button").length;
	assertEquals(9, noOfButtonsCreated);
}
